...
#
# generate_exercise_project.tcl: Tcl script for re-creating project 'exercise_test'
#
# Generated by Vivado on Fri Oct 19 17:26:54 +0200 2018
...
#
# 1. This project restoration tcl script (generate_exercise_project.tcl) that was generated.
#
...
#
#    "./sources/submodules/bcd2ascii.v"
#    "./sources/synthesis/clk_divider.v"
#    "./sources/submodules/dual2bcd.v"
#    "./sources/synthesis/global_toplevel.v"
#    "./sources/synthesis/kmh_test.v"
#    "./sources/synthesis/pulse_shape.v"
#    "./sources/synthesis/LCD_Bram_Big.v"
#    "./sources/synthesis/LCD_Bram_Small.v"
#    "./sources/synthesis/LCD_ClockDivider.v"
#    "./sources/synthesis/LCD_Control.v"
#    "./sources/synthesis/LCD_Controller.v"
#    "./sources/synthesis/LCD_macros.v"
#    "./sources/synthesis/LCD_PS_Converter.v"
#    "./sources/synthesis/LCD_SM_Signals.v"
#    "./sources/synthesis/LCD_SM_States.v"
#    "./sources/student/top_of_your_bicycle.v"
#    "./sources/constraints/pins.xdc"
#    "./sources/constraints/timings.xdc"
#    "./sources/testbench/tb_bicycle.v"
#
#*****************************************************************************************
...
set xilinxVersion 2017

# Set the project name
set project_name "bicycle_computer"

variable script_file
set script_file "generate_project.tcl"

if { $xilinxVersion < 2017 } {
	puts "xilinx version not supported. To old"
	return -404
}


if {[catch {current_project} result ]} {
	#no project open. error catched
} else {
	#project is already open. e.g. after runtime error of this script
	close_project 
}

# delete old project files if they exist
file delete [format "vivado/%s.xpr" $project_name]
file delete -force [format "vivado/%s.cache" $project_name]
file delete -force [format "vivado/%s.hw" $project_name]
file delete -force [format "vivado/%s.ip_user_files" $project_name]
file delete -force [format "vivado/%s.sim" $project_name]
file delete -force [format "vivado/%s.runs" $project_name]
...
# Create project
create_project ${project_name} ./vivado -part xc7z010clg400-1

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Reconstruct message rules
set_msg_config  -ruleid {3}  -string {{LCD_CONTROLLER}}  -suppress  -source 2
set_msg_config  -ruleid {4}  -string {{LCD_MEM_CONTROL}}  -suppress  -source 2
set_msg_config  -ruleid {5}  -string {{currDispSigEntry}}  -suppress  -source 2
set_msg_config  -ruleid {6}  -id {filemgmt 20-1763}  -suppress  -source 2
set_msg_config  -ruleid {7}  -id {Synth 8-3295}  -new_severity {ERROR}  -source 2
set_msg_config  -ruleid {8}  -id {Timing 38-282}  -new_severity {ERROR}  -source 2
set_msg_config  -ruleid {9}  -string {{inferring latch for variable 'stored_order_reg'}} -suppress -source 2
set_msg_config  -ruleid {10} -string {{design global_toplevel has port C86 driven by constant 0}} -suppress -source 2
set_msg_config  -ruleid {11} -id {DRC ZPS7-1} -new_severity {INFO} -source 2
...
set files [list \
 "[file normalize "$origin_dir/sources/submodules/bcd2ascii.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/clk_divider.v"]"\
 "[file normalize "$origin_dir/sources/submodules/dual2bcd.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/global_toplevel.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/kmh_test.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/pulse_shape.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_Bram_Big.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_Bram_Small.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_ClockDivider.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_Control.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_Controller.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_macros.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_PS_Converter.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_SM_Signals.v"]"\
 "[file normalize "$origin_dir/sources/synthesis/LCD_SM_States.v"]"\
 "[file normalize "$origin_dir/sources/student/top_of_your_bicycle.v"]"\
]
add_files -norecurse -fileset $obj $files


# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/sources/submodules/bcd2ascii.v"
...
set file "$origin_dir/sources/synthesis/clk_divider.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/kmh_test.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/submodules/dual2bcd.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/pulse_shape.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/student/top_of_your_bicycle.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_Bram_Big.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_Bram_Small.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_ClockDivider.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_Control.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_Controller.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_macros.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_PS_Converter.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_SM_Signals.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/LCD_SM_States.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sources/synthesis/global_toplevel.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "global_toplevel" -objects $obj
...
set file "[file normalize "$origin_dir/sources/constraints/pins.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/sources/constraints/pins.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/sources/constraints/timings.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/sources/constraints/timings.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set files [list \
 "[file normalize "$origin_dir/sources/testbench/tb_bicycle.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/sources/testbench/tb_bicycle.v"
set file [file normalize $file]
...
set_property -name "top" -value "tb_bicycle" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z010clg400-1 -flow {[format "Vivado Synthesis %s" $xilinxVersion]} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs synth_1]
  set_property flow [format "Vivado Synthesis %s" $xilinxVersion] [get_runs synth_1]
}
...
set_property -name "flow" -value [format "Vivado Synthesis %s" $xilinxVersion] -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z010clg400-1 -flow {[format "Vivado Implementation %s" $xilinxVersion]} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs impl_1]
  set_property flow [format "Vivado Implementation %s" $xilinxVersion] [get_runs impl_1]
}
...
set_property -name "flow" -value [format "Vivado Implementation %s" $xilinxVersion] -objects $obj
...
set_property -name "steps.write_bitstream.tcl.post" -value "[file normalize "$origin_dir/sources/tcl/generate_reports.tcl"]" -objects $obj
