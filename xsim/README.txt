...
#
# Generated by export_simulation on Fri Jul 04 21:11:18 CEST 2025
#
################################################################################
...
'-reset_run' switch to the './tb_bicycle.sh' script.

./tb_bicycle.sh -reset_run
...
./tb_bicycle.sh -noclean_files

For more information on the script, please type './tb_bicycle.sh -help'.
